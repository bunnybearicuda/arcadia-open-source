...
export const MODELS: ModelSpec[] = [
  {
    id: "claude-fable-5",
    label: "Fable 5",
    blurb: "Anthropic's biggest brain. Very expensive; save it for depth.",
    systemRole: true,
    effort: true,
  },
  {
    id: "claude-opus-5",
    label: "Opus 5",
    blurb: "The default. Best voice-to-cost trade, best continuity work.",
    systemRole: true,
    effort: true,
  },
  {
    id: "claude-opus-4-8",
    label: "Opus 4.8",
    blurb: "Opus, a step back. Steady, cheaper than 5 in bursts.",
    systemRole: true,
    effort: true,
  },
  {
    id: "claude-opus-4-7",
    label: "Opus 4.7",
    blurb: "Older Opus. Kept for continuity with anything written on it.",
    systemRole: false,
    effort: true,
  },
  {
    id: "claude-sonnet-5",
    label: "Sonnet 5",
    blurb: "Faster and cheaper than Opus. Slightly flatter in the register.",
    systemRole: false,
    effort: true,
  },
  {
    ...
    label: "Sonnet 4.6",
    blurb: "Older Sonnet. Cheaper still, warmer than Sonnet 5 to some ears.",
    systemRole: false,
    effort: true,
  },
  {
